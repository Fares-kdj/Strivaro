        ...
        <div class="mb-20">
          ...
          <div class="space-y-7">
            ...
            <div>
              ...
              <a
                href="/cdn-cgi/l/email-protection#32414742425d404672565d5f535b5c1c515d5f"
                class="font-heading text-dark hover:text-primary dark:hover:text-primary text-base dark:text-white"
              >
                <span
                  class="__cf_email__"
                  data-cfemail="a2919792928d9096a2868d8f838b8ccc818d8f"
                  >support@exemple.com</span
                >
              </a>
            </div>
          </div>
      ...
      <div class="-mx-4 flex flex-wrap py-5 md:py-7">
        ...
        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
          <div>
            ...
            >
              © 2025 Startup. Tous droits réservés
            </p>
          </div>
        </div>
      </div>
