      ...
      <div class="px-4 xl:container">
        <div class="-mx-4 flex flex-wrap items-center">
          <div class="w-full px-3 lg:w-1/2">
            <div
              class="mx-auto mb-12 max-w-[530px] text-center lg:mb-0 lg:ml-0 lg:text-left"
            >
              <span
              ...
              >
                <span
                  class="bg-primary mr-2 inline-block h-2 w-2 rounded-full"
                ></span>
            ...
            <h1
              ...
              data-wow-delay=".3s"
            >
              <span>STRIVARO,<br/> DU</span>
              <span style="color: #322FBF;"
                class="txt-type underline"
                data-wait="3000"
                data-words='["SENS", "STYLE", "RÉSULTAT"]'
              ></span>
            </h1>
              <p
                class="wow fadeInUp text-dark-text mb-12 text-base"
                data-wow-delay=".4s"
              >
                Chez STRIVARO, nous ne faisons pas <b>de la pub.</b>
                Nous concevons des stratégies d’acquisition <b>scalables, rentables et alignées
                sur vos objectifs business.</b> 
              </p>
              <div
              ...
              >
                ...
                >
                  Obtenez votre plan d’acquisition personnalisé
                  <span class="pl-3">
                    <svg
                      width="16"
                      height="16"
...
<section id="features" class="pt-14 sm:pt-20 lg:pt-[130px]">
      <div class="px-4 xl:container">
        ...
        >
          ...
          <p class="text-dark-text text-base">
            Nous construisons et pilotons vos campagnes d’acquisition avec une approche
            business-first, orientée données et résultats concrets.
          </p>
        </div>
        ...
        <div class="-mx-4 flex flex-wrap justify-center">
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <div>
                <h3
                  class="font-heading text-dark mb-3 text-xl font-medium sm:text-2xl md:mb-5 dark:text-white"
                >
                  Stratégie & Conseil
                </h3>
                <p class="text-dark-text text-base">
                  Funnel, positionnement, audit marketing
                </p>
              </div>
            </div>
          </div>
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              <div
                class="bg-primary/5 text-primary group-hover:bg-primary dark:group-hover:bg-primary dark:bg-primary-5 mx-auto mb-6 flex h-[70px] w-[70px] items-center justify-center rounded-full transition group-hover:text-white group-hover:opacity-100 md:mb-9 md:h-[90px] md:w-[90px] dark:bg-white/5 dark:text-white dark:group-hover:opacity-100"
              >
                <svg
                  width="44"
                  height="44"
              ...
              <div>
                ...
                <p class="text-dark-text text-base">
                  Identité visuelle, visuels publicitaires, storytelling
                </p>
              </div>
            </div>
          </div>
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <div>
                ...
                <p class="text-dark-text text-base">
                  Meta, Google, TikTok & autres plateformes
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <div>
                ...
                <p class="text-dark-text text-base">
                  Emailing, lead scoring, nurturing
                </p>
              </div>
            </div>
          </div>
            ...
            >
              ...
              <div>
                <h3
                  class="font-heading text-dark mb-3 text-xl font-medium sm:text-2xl md:mb-5 dark:text-white"
                >
                  Reporting & Scalabilité
                </h3>
                <p class="text-dark-text text-base">
                  Tableaux de bord, prévisions, croissance
                  pilotée
                </p>
              </div>
            </div>
      ...
      <div class="px-4 xl:container">
        ...
        >
          ...
          <p class="text-dark-text mx-auto max-w-[570px] text-base">
            Découvrez comment nous alignons stratégie, expertise et données pour maximiser votre croissance.
          </p>
        </div>
        ...
        >
          ...
          <div class="w-full">
            <!-- Tab Panel 1: Business-First & ROI-Driven -->
            <div class="tabPanel">
              <div class="-mx-4 flex w-full flex-wrap items-center pt-[70px]">
                ...
                <div class="w-full px-4 lg:w-1/2">
                  <div class="max-w-[565px] lg:ml-auto">
                    ...
                    >
                      Business-First & ROI-Driven
                    </h2>
                    <p class="text-dark-text mb-6 text-base">
                      Tout commence par vos objectifs commerciaux. Chaque euro investi doit avoir un but : croître.
                    </p>
                  </div>
                </div>
              </div>
            </div>
            <!-- Tab Panel 2: Expertise Multi-Plateformes -->
            <div class="tabPanel">
              <div class="-mx-4 flex w-full flex-wrap items-center pt-[70px]">
                <div class="w-full px-4 lg:w-1/2">
                  <div
                  ...
                  >
                    <div class="absolute top-0 left-0">
                      <img src="src/images/about/image-3.jpg" alt="about-image" />
                    </div>
                    <div class="absolute top-1/2 right-0 z-10 -translate-y-1/2">
                      <img src="src/images/about/image-4.jpg" alt="about-image" />
                      <div
                        class="border-primary/10 bg-primary/5 absolute -top-5 -left-5 -z-10 h-full w-full border backdrop-blur-[6px] dark:border-white/10 dark:bg-white/10"
                      ></div>
                    </div>
                ...
                <div class="w-full px-4 lg:w-1/2">
                  <div class="max-w-[565px] lg:ml-auto">
                    ...
                    <p class="text-dark-text mb-6 text-base">
                      Nous maîtrisons les codes et algorithmes des meilleurs leviers d’acquisition pour activer les bons canaux au bon moment.
                    </p>
                  </div>
                </div>
              </div>
            </div>
            <!-- Tab Panel 3: Accompagnement Stratégique & Data-Driven -->
            <div class="tabPanel">
              <div class="-mx-4 flex w-full flex-wrap items-center pt-[70px]">
                <div class="w-full px-4 lg:w-1/2">
                  <div
                  ...
                  >
                    <div class="absolute top-0 left-0">
                      <img src="src/images/about/image-5.jpg" alt="about-image" />
                    </div>
                    <div class="absolute top-1/2 right-0 z-10 -translate-y-1/2">
                      <img src="src/images/about/image-6.jpg" alt="about-image" />
                      <div
                        class="border-primary/10 bg-primary/5 absolute -top-5 -left-5 -z-10 h-full w-full border backdrop-blur-[6px] dark:border-white/10 dark:bg-white/10"
                      ></div>
                    </div>
                    <div class="absolute top-24 right-0 z-abscde z-40">
                      <svg
                        width="72"
                        height="38"
                        viewBox="0 0 72 38"
                ...
                <div class="w-full px-4 lg:w-1/2">
                  <div class="max-w-[565px] lg:ml-auto">
                    <h2
                      class="font-heading text-dark mb-8 text-2xl font-bold sm:text-[40px] sm:leading-[50px] dark:text-white"
                    >
                      Accompagnement Stratégique & Data-Driven
                    </h2>
                    <p class="text-dark-text mb-6 text-base">
                      On ne vous vend pas du rêve. On vous guide avec transparence à chaque étape.
                    </p>
                  </div>
                </div>
              </div>
    ...
    <!-- <section id="portfolio" class="pt-14 sm:pt-20 lg:pt-[130px]">
      <div class="px-4 xl:container"> -->
        ...
        <div class="w-full">
          ...
          >
            <button
              class="active font-heading text-dark px-5 text-base whitespace-nowrap dark:text-white"
              data-filter="*"
            >
              All
            </button>
            <button
              class="font-heading text-dark px-5 text-base whitespace-nowrap dark:text-white"
          ...
          <div class="portfolio-grid -mx-4 flex flex-wrap">
            ...
            <div class="grid-item ecom w-full px-4 lg:w-2/3">
              <div
                class="wow fadeInUp group relative mb-10 overflow-hidden rounded-sm"
                data-wow-delay=".2s"
              >
                <img
                ...
                >
                  <div
                    class="border-r border-[#e9e9e9]/30 pr-4 sm:pr-5 lg:pr-4 xl:pr-5"
                  >
                    <h3
    ...
    <!-- ===== Pourquoi Section Start ===== -->
    <section id="why-strivaro" class="pt-14 sm:pt-20 lg:pt-[130px]">
      <div class="px-4 xl:container">
        <!-- Section Title -->
        <div
          class="wow fadeInUp relative mx-auto mb-12 pt-6 text-center md:mb-20 lg:pt-16"
          data-wow-delay=".2s"
        >
          <span class="title"> La Raison </span>
          <h2
          ...
          <p class="text-dark-text mx-auto max-w-[620px] text-base">
            STRIVARO est né d’une conviction simple mais puissante.<br/> Dans un monde dominé par les géants, nous avons créé un modèle d’agence où ingéniosité stratégique, créativité sur mesure et culture du ROI permettent aux entreprises sincères de franchir un cap décisif.
          </p>
        </div>

        <div class="wow fadeInUp -mx-4 flex flex-wrap" data-wow-delay=".3s">
          <!-- Strive, Then Scale Subsection -->
          <div class="w-full px-4 lg:w-1/2">
            <div class="mb-10">
              <h3
                class="font-heading text-dark mb-4 text-2xl font-semibold sm:text-3xl dark:text-white"
              >
                Strive, Then Scale
              </h3>
              <p class="text-dark-text text-base">
                On commence par comprendre, challenger, construire. Puis on déploie, on mesure, on optimise. Notre approche est méthodique et orientée vers des résultats tangibles, adaptée à chaque étape de votre croissance.
              </p>
            </div>
          </div>
          <!-- Preuves sociales & résultats concrets Subsection -->
          <div class="w-full px-4 lg:w-1/2">
            <div class="mb-10">
              <h3
                class="font-heading text-dark mb-4 text-2xl font-semibold sm:text-3xl dark:text-white"
              >
                Preuves sociales & résultats concrets
              </h3>
              <ul class="space-y-4">
                <li class="flex items-start">
                  ...
                  <span class="text-dark-text text-base">ROAS x4 sur une campagne e-commerce</span>
                </li>
                <li class="flex items-start">
                  <svg
                    class="mr-2 h-5 w-5 text-primary"
                  ...
                  <span class="text-dark-text text-base">CPA -42% en 3 mois pour une PME B2B</span>
                </li>
                <li class="flex items-start">
                  <svg
                    class="mr-2 h-5 w-5 text-primary"
                  ...
                  <span class="text-dark-text text-base">+115% de taux de conversion sur un tunnel optimisé</span>
                </li>
              </ul>
            </div>
          </div>
...
<!-- ===== Pourquoi Section End ===== -->
    ...
    <section id="testimonial" class="pt-14 sm:pt-20 lg:pt-[130px]">
      <div class="px-4 xl:container">
        ...
        >
          ...
          >
            Regards sur Strivaro
          </h2>
          <p class="text-dark-text mx-auto max-w-[620px] text-base">
            Derrière chaque réussite, il y a une relation de confiance bâtie sur l’écoute et l’engagement.
          </p>
        </div>
                ...
                <div class="-mx-4 flex flex-wrap items-center">
                  <div class="order-last w-full px-4 lg:order-first lg:w-1/2">
                    <div class="text-center lg:text-left">
                      <p
                        class="font-heading text-dark-text mb-9 text-base font-light lg:text-lg xl:text-2xl"
                      >
                      ...
                      <h3
                        class="font-heading text-dark mb-1 text-xl dark:text-white"
                      >
                        Deniyal Shifer
                      </h3>
                      <p class="text-dark-text text-base">
                  ...
                  <div class="w-full px-4 lg:w-1/2">
                    <div
                      class="relative mx-auto mb-9 h-[420px] w-full max-w-[420px] lg:mr-0 lg:mb-0"
                    >
    ...
    <section class="pt-14 sm:pt-20 lg:pt-24">
      <div class="px-4 xl:container">
        ...
        >
          <h2
            class="font-heading text-dark mb-5 text-[38px] leading-tight font-semibold dark:text-white"
          >
            Ils nous font confiance
          </h2>
          <p class="text-dark-text text-base">
           Des collaborations vraies, des résultats concrets.
          </p>
        </div>
          ...
          <div class="wow fadeInUp -mx-4 flex flex-wrap" data-wow-delay=".2s">
            <div class="w-full px-4">
              <div class="flex flex-wrap items-center justify-center">
                ...
                >
                  <img
                    src="src/images/brands/tailadmin.svg"
                    alt="image"
                    class="hidden h-10 w-full dark:block"
                  />
                  <img
                    src="src/images/brands/tailadmin-2.svg"
                    alt="image"
    ...
    <!-- <section id="pricing" class="pt-14 sm:pt-20 lg:pt-[130px]">
      <div class="px-4 xl:container">
        ...
        >
          ...
          <div class="w-full sm:w-1/2 lg:w-1/3">
            ...
            >
              <div class="border-b dark:border-[#2E333D]">
                <h3
                  class="font-heading text-dark mb-2 text-3xl font-medium dark:text-white"
                >
                  Free
                </h3>
          ...
          <div
            class="w-full sm:w-1/2 sm:border-l lg:w-1/3 lg:border-x dark:border-[#2E333D]"
          >
            <div
              class="wow fadeInUp pt-10 pb-20 text-center"
              data-wow-delay=".3s"
        ...
        <div class="pt-12 text-center">
          <h3
            class="font-heading text-dark mb-5 text-xl font-medium sm:text-3xl dark:text-white"
          >
              ...
              <div class="wow fadeInUp mb-10" data-wow-delay=".2s">
                ...
                <div>
                  <div class="mb-4 flex items-center">
                    <p
                      class="font-heading text-dark-text flex items-center pr-5 text-base"
                    >
                      <span class="pr-2">
                        <svg
                          width="18"
                    ...
                    <p
                      class="font-heading text-dark-text flex items-center text-base"
                    >
                      <span class="pr-2">
                        <svg
                          width="18"
  ...
  <div class="px-4 xl:container">
    <div
        ...
        >
          ...
          <p class="text-dark-text mx-auto max-w-[620px] text-base">
            Trouvez les réponses aux questions les plus courantes ci-dessous.
          </p>
        </div>

    <div class="faq-container max-w-[800px] mx-auto">
      <div class="faq-item border-b dark:border-[#2E333D] wow fadeInUp" data-wow-delay=".3s">
        <button class="faq-question font-heading text-dark text-lg font-medium w-full text-left py-4 flex justify-between items-center dark:text-white">
          Quels budgets accompagnez-vous ?
          <span class="faq-toggle text-2xl">+</span>
        </button>
        <div class="faq-answer text-dark-text text-base py-4">
          À partir de 1 000€/mois en publicité (nous optimisons même les petits
          budgets).
        </div>
      </div>
      <div class="faq-item border-b dark:border-[#2E333D] wow fadeInUp" data-wow-delay=".4s">
        <button class="faq-question font-heading text-dark text-lg font-medium w-full text-left py-4 flex justify-between items-center dark:text-white">
          Travaillez-vous avec des startups ou des PME ?
          <span class="faq-toggle text-2xl">+</span>
        </button>
        <div class="faq-answer text-dark-text text-base py-4">
          Oui. STRIVARO est justement conçu pour leur offrir une expertise de haut
          niveau.
        </div>
      </div>
      <div class="faq-item border-b dark:border-[#2E333D] wow fadeInUp" data-wow-delay=".5s">
        <button class="faq-question font-heading text-dark text-lg font-medium w-full text-left py-4 flex justify-between items-center dark:text-white">
          Combien de temps avant de voir des résultats ?
          <span class="faq-toggle text-2xl">+</span>
        </button>
        <div class="faq-answer text-dark-text text-base py-4">
          Selon la maturité de votre compte, les premiers résultats apparaissent souvent
          sous 30 jours.
        </div>
      </div>
    </div>
              ...
              <div class="w-full px-4 lg:w-1/2">
                ...
                >
                  ...
                  <h2
                    class="font-heading text-dark mb-5 text-3xl font-semibold sm:text-4xl md:text-[50px] md:leading-[60px] dark:text-white"
                  >
                    Besoin de clarté dans vos actions marketing ?
                  </h2>
                </div>
              </div>
...
<footer
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    faqItems.forEach((item) => {
      ...
      // Initialiser les réponses avec transition douce
...
<script>
  ...
  <script defer src="bundle.js"></script><script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'93d2574e9b165eeb',t:'MTc0NjgwNTcwNi4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"93d2574e9b165eeb","version":"2025.4.0-1-g37f21b1","r":1,"token":"9a6015d415bb4773a0bff22543062d3b","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}}}' crossorigin="anonymous"></script>
</body>
</html>
