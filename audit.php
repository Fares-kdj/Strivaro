...
<html lang="fr" class="dark">
  ...
  <body class="dark:bg-dark">
        ...
        <div class="flex w-full flex-wrap px-5 lg:flex-nowrap lg:items-center lg:px-5 xl:px-10 2xl:px-20">
            ...
            <div class="w-full self-center">
                ...
                <ul class="navbar flex flex-col items-center justify-center space-y-5 text-center lg:flex-row lg:justify-start lg:space-y-0 lg:space-x-10">
                    ...
                    <li>
                    <a href="#" class="menu-scroll active font-heading text-dark-text hover:text-primary inline-flex items-center justify-center text-center text-base dark:hover:text-white">
                        Audit
                    </a>
                    </li>
                </ul>
   ...
   <section id="why-audit" class="pt-14 sm:pt-20 lg:pt-[130px] bg-white dark:bg-dark">
  <div class="px-4 xl:container">
    <div class="wow fadeInUp relative mx-auto mb-12 max-w-[620px] pt-6 text-center md:mb-20 lg:pt-16" data-wow-delay=".2s">
      ...
      <h2 class="font-heading text-dark mb-5 text-3xl font-semibold sm:text-4xl md:text-[50px] md:leading-[60px] dark:text-white">
        Pourquoi Réserver Un Audit Avec STRIVARO ?
      </h2>
      <p class="text-dark-text text-base leading-relaxed">
        Chez STRIVARO, chaque collaboration débute par une phase d’analyse et de compréhension.
        Nous croyons qu’avant d’investir davantage, il faut savoir où agir pour obtenir plus de résultats.
        C’est pourquoi nous vous proposons un <b>audit complet et gratuit</b> de votre système d’acquisition client, sans engagement.
      </p>
    </div>
    ...
    <div class="-mx-4 flex flex-wrap justify-center">
      ...
      <div class="w-full px-4 md:w-1/2">
        <div class="wow fadeInUp mb-10 flex items-start justify-center text-left md:mb-16" data-wow-delay=".2s">
          <div class="flex items-start">
            <svg class="mr-2 h-5 w-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
            </svg>
            <p class="text-dark-text text-base leading-relaxed">
              Que vous soyez déjà en campagne ou en préparation de lancement,
            </p>
          </div>
        </div>
      </div>
      ...
      <!-- Bloc 2 -->
      <div class="w-full px-4 md:w-1/2">
        <div class="wow fadeInUp mb-10 flex items-start justify-center text-left md:mb-16" data-wow-delay=".25s">
          <div class="flex items-start">
            <svg class="mr-2 h-5 w-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
            </svg>
            <p class="text-dark-text text-base leading-relaxed">
              Que vous investissiez 500 € ou 20 000 € par mois,
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="w-full px-4">
        <div class="wow fadeInUp text-center" data-wow-delay=".3s">
          <p class="text-dark-text text-base italic leading-relaxed">
            ... cet échange stratégique vous permettra de poser des bases solides pour scaler.
          </p>
        </div>
      </div>
    </div>
 ...
 <section id="analysis" class="pt-14 sm:pt-20 lg:pt-[130px]">
  <div class="px-4 xl:container">
    <div class="wow fadeInUp relative mx-auto mb-12 max-w-[620px] pt-6 text-center md:mb-20 lg:pt-16" data-wow-delay=".2s">
      ...
      <p class="text-dark-text text-base">
        Notre audit couvre tous les aspects clés de votre stratégie d’acquisition pour identifier vos <b>quick wins</b> et formuler des recommandations actionnables immédiatement.
      </p>
    </div>
    <div class="-mx-4 flex flex-wrap justify-center">
      ...
      <div class="w-full px-4 md:w-1/2 lg:w-1/3">
        <div class="wow fadeInUp group mx-auto mb-10 max-w-[380px] text-center md:mb-16" data-wow-delay=".2s">
          <div class="bg-primary/5 text-primary group-hover:bg-primary group-hover:text-white mx-auto mb-6 flex h-[70px] w-[70px] items-center justify-center rounded-full transition md:mb-9 md:h-[90px] md:w-[90px] dark:bg-white/5 dark:text-white dark:group-hover:bg-primary dark:group-hover:text-white">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
          ...
          <div>
            ...
            <p class="text-dark-text text-base">
              Analyse de vos campagnes sur Meta, Google, TikTok, etc.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="w-full px-4 md:w-1/2 lg:w-1/3">
        <div class="wow fadeInUp group mx-auto mb-10 max-w-[380px] text-center md:mb-16" data-wow-delay=".25s">
          ...
          <div>
            ...
            <p class="text-dark-text text-base">
              Évaluation de vos landing pages, offres et parcours utilisateur.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="w-full px-4 md:w-1/2 lg:w-1/3">
        <div class="wow fadeInUp group mx-auto mb-10 max-w-[380px] text-center md:mb-16" data-wow-delay=".3s">
          ...
          <div>
            ...
            <p class="text-dark-text text-base">
              Étude de vos visuels, vidéos et messages.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="w-full px-4 md:w-1/2 lg:w-1/3">
        <div class="wow fadeInUp group mx-auto mb-10 max-w-[380px] text-center md:mb-16" data-wow-delay=".35s">
          ...
          <div>
            ...
            <p class="text-dark-text text-base">
              Revue de votre gestion client et automatisation marketing.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="w-full px-4 md:w-1/2 lg:w-1/3">
        <div class="wow fadeInUp group mx-auto mb-10 max-w-[380px] text-center md:mb-16" data-wow-delay=".4s">
          ...
          <div>
            ...
            <p class="text-dark-text text-base">
              Analyse de votre CPA, ROAS, taux de conversion, etc.
            </p>
          </div>
        </div>
      </div>
   ...
   <section id="target" class="pt-14 sm:pt-20 lg:pt-[130px]">
  <div class="wow fadeInUp relative mx-auto mb-12 max-w-[620px] pt-6 text-center md:mb-20 lg:pt-16" data-wow-delay=".2s">
    <span class="title">ÀQUI?</span>
    <h2 class="font-heading text-dark mb-5 text-3xl font-semibold sm:text-4xl md:text-[50px] md:leading-[60px] dark:text-white">
      Cet Audit Est Pour Vous si 
    </h2>
  </div>
  <div class="-mx-4 flex flex-wrap justify-center">
    <div class="w-full px-4 md:w-1/2">
      <div class="wow fadeInUp mb-10 text-center md:mb-16" data-wow-delay=".2s">
        <p class="text-dark-text text-base inline-flex items-center justify-center">
          <svg class="mr-2 h-5 w-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
          </svg>
          Vous sentez que vos campagnes n’exploitent pas tout leur potentiel
        </p>
      </div>
    </div>
    <div class="w-full px-4 md:w-1/2">
      <div class="wow fadeInUp mb-10 text-center md:mb-16" data-wow-delay=".25s">
        <p class="text-dark-text text-base inline-flex items-center justify-center">
          <svg class="mr-2 h-5 w-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
          </svg>
          Vous avez besoin d’un œil externe pour structurer ou optimiser votre stratégie
        </p>
      </div>
    </div>
    <div class="w-full px-4 md:w-1/2">
      <div class="wow fadeInUp mb-10 text-center md:mb-16" data-wow-delay=".3s">
        <p class="text-dark-text text-base inline-flex items-center justify-center">
          <svg class="mr-2 h-5 w-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
          </svg>
          Vous voulez scaler en gardant le contrôle sur vos résultats
        </p>
      </div>
    </div>
    <div class="w-full px-4 md:w-1/2">
      <div class="wow fadeInUp mb-10 text-center md:mb-16" data-wow-delay=".35s">
        <p class="text-dark-text text-base inline-flex items-center justify-center">
          <svg class="mr-2 h-5 w-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
          </svg>
          Vous lancez une nouvelle offre ou un nouveau produit et vous voulez éviter les erreurs coûteuses
        </p>
      </div>
    </div>
  </div>
      ...
      function onScroll(event) {
        ...
        for (let i = 0; i < sections.length; i++) {
          ...
          if (val.includes("#")) {
            ...
            refElement = document.querySelector("#audit");
          }
